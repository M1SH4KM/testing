...
RegisterNetEvent('qb-cityhall:server:requestId', function(item, hall)
    ...
    if not Player.Functions.RemoveMoney("cash", itemInfo.cost) then return TriggerClientEvent('QBCore:Notify', src, ('No tienes suficiente dinero contigo, necesitas %s efectivo'):format(itemInfo.cost), 'error') end
    local info = {}
    ...
    elseif item == "driver_license" then
        ...
        info.lastname = Player.PlayerData.charinfo.lastname
        info.birthdate = Player.PlayerData.charinfo.birthdate
        info.type = "Licencia de conducir clase R"
        if Player.PlayerData.metadata['licences']['bike'] then
            info.endorsement = 'Endoso de motocicleta'
        else
    ...
    elseif item == 'cdl_license' then
        ...
        info.lastname = Player.PlayerData.charinfo.lastname
        info.birthdate = Player.PlayerData.charinfo.birthdate
        info.type = "Licencia de conducir clase A"
